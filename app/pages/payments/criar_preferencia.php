...
// ============================================================
// CRIAR PREFERÃŠNCIA MERCADO PAGO
// Chamado apÃ³s criar o pedido com forma_pagamento = 'app'
// ============================================================
...
if ($id_pedido <= 0) {
    redirecionar('painel_cliente.php', 'Pedido invÃ¡lido.', 'erro');
}

// Buscar pedido â€” deve pertencer ao cliente logado, ser do tipo 'app' e estar pendente
$stmt = $conn->prepare(
...
if (!$pedido) {
    redirecionar('painel_cliente.php', 'Pedido nÃ£o encontrado ou jÃ¡ pago.', 'erro');
}
...
// â”€â”€ MONTAR PREFERÃŠNCIA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
$items_mp = [];
$subtotal_itens = 0.0;
...
if ($ajuste_total < 0) {
    ...
    redirecionar('painel_cliente.php', 'NÃ£o foi possÃ­vel gerar o pagamento deste pedido.', 'erro');
}
...
if ($ajuste_total > 0) {
    $items_mp[] = [
        ...
        'description' => 'Ajuste necessÃ¡rio para que o checkout reflita o total do pedido.',
        'quantity'    => 1,
...
// â”€â”€ CHAMAR API DO MERCADO PAGO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ REDIRECIONAR PARA O CHECKOUT DO MERCADO PAGO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
